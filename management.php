      ...
      <div class="tab-content">
        <div class="tab-pane active" id="hometab">
          <div class="hm-content">
            <h3>Management</h3>
            <div class="mang-dvr">
              <div class="mang-thump"> <img src="<?php echo $resourcePath; ?>img/layout/man.jpg"/>
                <h4>Raj Mohan <br/>
                  <span>(Principal)</span></h4>
              </div>
            ...
            <div class="mang-dvr">
              <div class="mang-thump"> <img src="<?php echo $resourcePath; ?>img/layout/man1.jpg"/>
                <h4>Jhones <br/>
                  <span>(Manager)</span></h4>
              </div>
              <p align="justify"> The three schools, two junior and one senior,
                Foundation in Worcester make up one of the leading academic institutions in the West Midlands and offer an outstanding educational experience.
                The Foundation was inspected at the end of 2011 and you can download here a copy of the official report from ISI.
            ...
            <div class="mang-dvr">
              <div class="mang-thump"> <img src="<?php echo $resourcePath; ?>img/layout/man2.jpg"/>
                <h4>Joby mathikkal <br/>
                  <span>(PTA President )</span></h4>
              </div>
              <p align="justify"> The three schools, two junior and one senior,
                Foundation in Worcester make up one of the leading academic institutions in the West Midlands and offer an outstanding educational experience.
                The Foundation was inspected at the end of 2011 and you can download here a copy of the official report from ISI.
