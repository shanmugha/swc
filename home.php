		...
		<div class="event_news">
			<div class="tabs">
				<ul class="nav nav-tabs" id="myTab">
				  <li class="active"><a data-toggle="tab" href="#home"><i class="icon-calendar m5"></i> Events</a></li>
				  <li class=""><a data-toggle="tab" href="#profile"><i class="icon-bullhorn m5"></i> News</a></li>
